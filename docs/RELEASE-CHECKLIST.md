# v0.6.14 release checklist

This checklist defines the final repository and package gate for Exchange EWS MCP v0.6.14.

## Repository contract

- [ ] `src/exchange_ews_mcp/__init__.py` reports `0.6.14`.
- [ ] Production and debug profiles expose 19 and 25 tools respectively.
...
- [ ] Tag the exact commit as `v0.6.14` only after all environment-owned live DT checks pass.
