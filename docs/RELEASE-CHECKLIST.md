...
This checklist defines the final repository and package gate for Exchange EWS MCP v0.9.0.

## Repository contract

- [ ] `src/exchange_ews_mcp/__init__.py` reports `0.9.0`.
...
- [ ] Tag the exact commit as `v0.9.0` only after all environment-owned live DT checks pass.
