...
def build_get_attachment_request(
    *,
    exchange_version: str,
    attachment_id: str,
) -> bytes:
    ...
    attachment_shape = ET.SubElement(get_attachment, q(MESSAGES_NS, "AttachmentShape"))
    ET.SubElement(attachment_shape, q(TYPES_NS, "IncludeMimeContent")).text = "false"
    attachment_ids = ET.SubElement(get_attachment, q(MESSAGES_NS, "AttachmentIds"))
    ET.SubElement(attachment_ids, q(TYPES_NS, "AttachmentId"), {"Id": attachment_id})
    return _serialize(envelope)
